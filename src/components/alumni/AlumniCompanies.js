        ...
        return (
          <div className="logo-block">
            <div className="logo-container">
              ...
              <a className="logo -logo-7 -sm" href="http://www.ca.com/" target="_blank" style={{backgroundImage:`url(https://d1cvw29nua6zwm.cloudfront.net/logos/company-logo_catechnologies.png)`}}></a>
              ...
              <a className="logo -logo-13 -sm" href="http://www.homeadvisor.com/" target="_blank" style={{backgroundImage:`url(https://logo.clearbit.com/homeadvisor.com)`}}></a>
